...
import { Card as MatCard, CardTitle, Button, Icon } from "react-materialize";
...
class GiftDetail extends Component {
  ...
  componentDidMount() {
    ...
    API.getGift(this.props.giftid)
      .then(res => {
        ...
        const searchScript1 =
          '<script type="text/javascript">amzn_assoc_placement = "adunit0";amzn_assoc_tracking_id = "proj3team6-20";amzn_assoc_ad_mode = "search";amzn_assoc_ad_type = "smart";amzn_assoc_marketplace = "amazon";amzn_assoc_region = "US";amzn_assoc_title = "Shop Related Products";amzn_assoc_default_search_phrase = "' +
          searchQuery +
          '";amzn_assoc_default_category = "All";amzn_assoc_linkid = "d3d3fe6c790f6d1bac8a0025e3a0d068";amzn_assoc_rows = "6";amzn_assoc_design = "text_links";</script><script src="//z-na.amazon-adsystem.com/widgets/onejs?MarketPlace=US"></script>';
        const searchScript2 =
          '<script type="text/javascript">amzn_assoc_placement = "adunit0";amzn_assoc_tracking_id = "proj3team6-20";amzn_assoc_ad_mode = "search";amzn_assoc_ad_type = "smart";amzn_assoc_marketplace = "amazon";amzn_assoc_region = "US";amzn_assoc_title = "Shop Related Products";amzn_assoc_default_search_phrase = "' +
          searchQuery +
          '";amzn_assoc_default_category = "All";amzn_assoc_linkid = "344c640cdfb4c82421aedd0a562c76db";amzn_assoc_search_bar = "true";amzn_assoc_search_bar_position = "top";</script><script src="//z-na.amazon-adsystem.com/widgets/onejs?MarketPlace=US"></script>';
  ...
  searchAuction = callback => {
    API.searchEbay(
      this.state.gift.code
        ? this.state.gift.giftName
                  ...
                  {this.state.searchResults.map((searchResult, index) => (
                    <Col key={index} size="s12" style={{ flex: "none" }}>
                      <MatCard
                        ...
                        header={
                          <CardTitle
                            image={searchResult.galleryURL[0]}
                          ></CardTitle>
                        }
                      >
                        <a target="blank" href={searchResult.viewItemURL}>
